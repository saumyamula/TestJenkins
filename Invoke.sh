...
ParameterAll="$REGION $HA $AMI_NAME $VPC_ID $INSTANCE_TYPE $HOST_NAME $VPC_SUBNET $INSTALL_TYPE $DB_TYPE $KEY_NAME $DB_NAME $SYS_PASS $STANDBY_VPC_SUBNET $STANDBY_VPC_SUBNET $DB_SERVICE"
